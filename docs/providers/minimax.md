...
coding-focused release is **MiniMax M2.7** (December 23, 2025), built for
real-world complex tasks.

Source: [MiniMax M2.7 release note](https://www.minimax.io/news/minimax-m25)
...
- **Speed:** `MiniMax-M2.7-highspeed` is the official fast tier in MiniMax docs.
...
We have seen strong results with MiniMax M2.7 on powerful hardware (e.g. a
