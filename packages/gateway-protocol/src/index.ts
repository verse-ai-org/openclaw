...
export const validateChannelsCatalogParams = lazyCompile<ChannelsCatalogParams>(
  ChannelsCatalogParamsSchema,
);
export const validateChannelsEnableParams = lazyCompile<ChannelsEnableParams>(
  ChannelsEnableParamsSchema,
);
export const validateChannelsRecipientsParams = lazyCompile<ChannelsRecipientsParams>(
  ChannelsRecipientsParamsSchema,
);
...
export const validatePluginsStatusParams = lazyCompile<PluginsStatusParams>(
  PluginsStatusParamsSchema,
);
export const validatePluginsEnableParams = lazyCompile<PluginsEnableParams>(
  PluginsEnableParamsSchema,
);
