...
/** Enables or disables one channel plugin in config. */
...
/** Lists installable and installed channel plugins for the UI catalog. */
...
export const ChannelCatalogEntrySchema = Type.Object(
  {
    ...
    pluginEnabled: Type.Optional(Type.Boolean()),
  },
  { additionalProperties: false },
);
...
/** Lists known outbound recipients across configured channels. */
...
export const WebLoginWaitParamsSchema = Type.Object(
  {
    ...
    sessionKey: Type.Optional(Type.String()),
    verifyCode: Type.Optional(Type.String({ maxLength: 32 })),
  },
  { additionalProperties: false },
);
