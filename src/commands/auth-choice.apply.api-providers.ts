...
> = {
  "ai-gateway-api-key": {
    ...
    applyDefaultConfig: (cfg) =>
      applyKnownProviderConfig(cfg, "ai-gateway", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "ai-gateway", "provider"),
  ...
  "moonshot-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "moonshot", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "moonshot", "provider"),
  },
  "moonshot-api-key-cn": {
    provider: "moonshot",
    profileId: "moonshot:default",
    ...
    setCredential: setMoonshotApiKey,
    defaultModel: MOONSHOT_DEFAULT_MODEL_REF,
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "moonshot-cn", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "moonshot-cn", "provider"),
  },
  "kimi-code-api-key": {
    ...
    applyDefaultConfig: (cfg) =>
      applyKnownProviderConfig(cfg, "kimi-coding", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "kimi-coding", "provider"),
  ...
  "xiaomi-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "xiaomi", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "xiaomi", "provider"),
  ...
  "mistral-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "mistral", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "mistral", "provider"),
  ...
  "deepseek-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "deepseek", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "deepseek", "provider"),
  ...
  "venice-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "venice", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "venice", "provider"),
  ...
  "opencode-zen": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "opencode", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "opencode", "provider"),
  ...
  "opencode-go": {
    ...
    applyDefaultConfig: (cfg) =>
      applyKnownProviderConfig(cfg, "opencode-go", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "opencode-go", "provider"),
  ...
  "together-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "together", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "together", "provider"),
  ...
  "qianfan-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "qianfan", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "qianfan", "provider"),
  ...
  "kilocode-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "kilocode", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "kilocode", "provider"),
  ...
  "modelstudio-api-key-cn": {
    ...
    applyDefaultConfig: (cfg) =>
      applyKnownProviderConfig(cfg, "modelstudio-cn", "default-model"),
    applyProviderConfig: (cfg) =>
      applyKnownProviderConfig(cfg, "modelstudio-cn", "provider"),
  ...
  "modelstudio-api-key": {
    ...
    setCredential: setModelStudioApiKey,
    defaultModel: MODELSTUDIO_DEFAULT_MODEL_REF,
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "modelstudio", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "modelstudio", "provider"),
    noteDefault: MODELSTUDIO_DEFAULT_MODEL_REF,
    noteMessage: [
      "Get your API key at: https://bailian.console.aliyun.com/",
  ...
  "synthetic-api-key": {
    ...
    applyDefaultConfig: (cfg) => applyKnownProviderConfig(cfg, "synthetic", "default-model"),
    applyProviderConfig: (cfg) => applyKnownProviderConfig(cfg, "synthetic", "provider"),
    normalize: (value) => String(value ?? "").trim(),
    validate: (value) => (String(value ?? "").trim() ? undefined : "Required"),
  },
};
