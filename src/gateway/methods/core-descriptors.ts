...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "config.provider.apply", scope: "operator.admin", controlPlaneWrite: true },
  ...
  { name: "plugins.status", scope: "operator.read" },
  { name: "plugins.enable", scope: "operator.admin" },
  ...
  { name: "skills.file.get", scope: "operator.read" },
  { name: "skills.file.set", scope: "operator.admin" },
  { name: "skills.search", scope: "operator.read" },
  { name: "skills.detail", scope: "operator.read" },
  { name: "skills.bins", scope: "node" },
  { name: "skills.import", scope: "operator.admin" },
  { name: "skills.remove", scope: "operator.admin" },
  ...
  { name: "chat.status", scope: "operator.read" },
  { name: "chat.tools.subscribe", scope: "operator.read" },
  { name: "chat.send", scope: "operator.write" },
  { name: "profile.parse", scope: "operator.write" },
