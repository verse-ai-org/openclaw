...
const loadProfileHandlers = lazyHandlerModule(
  () => import("./server-methods/profile.js"),
  (module) => module.profileHandlers,
);
...
export const coreGatewayHandlers: GatewayRequestHandlers = {
  ...
  ...createLazyCoreHandlers({
    methods: ["plugins.status", "plugins.enable", "plugins.install"],
    loadHandlers: loadPluginsHandlers,
  }),
  ...createLazyCoreHandlers({
    methods: ["profile.parse"],
    loadHandlers: loadProfileHandlers,
  }),
  ...createLazyCoreHandlers({
    methods: [
      "config.get",
