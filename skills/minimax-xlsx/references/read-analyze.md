...
If the user does not explicitly provide an output file path for analysis artifacts, save outputs under:
- macOS/Linux: `/Documents/Bossim/Excel/`
- Windows: `C:\Users\<username>\Documents\Bossim\Excel\`

Create the directory if it does not exist, and use a descriptive filename (for example: `analysis-report.md`, `analysis-report.json`, or `summary.xlsx`).
