...
```bash
# single slide
./scripts/render.sh "$HOME/Documents/Bossim/Html/my-talk/index.html"

# all slides (autodetect count by looking for .slide sections)
./scripts/render.sh "$HOME/Documents/Bossim/Html/my-talk/index.html" all

# explicit slide count + output dir
./scripts/render.sh "$HOME/Documents/Bossim/Html/my-talk/index.html" 12 out/my-talk-png
```
