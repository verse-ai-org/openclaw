...
subgraph "外部依赖"
M[lucide-react<br/>图标库]
N[Zod<br/>类型验证]
O[React<br/>组件框架]
P[Motion Safe<br/>动画库]
end
A --> B
A --> C
C --> D
...
- [interactive-registry.tsx:215-255](file://ui-react/src/components/chat/interactive/interactive-registry.tsx#L215-L255)
...
J[Separator]
K[Icon Resolver]
L[Interactive Registry]
M[Interaction Manifest]
end
ApprovalCard --> A
ApprovalCard --> B
ApprovalCard --> C
...
该组件为 OpenClaw 项目提供了可靠的审批功能基础，其现代化的架构设计和丰富的功能特性使其成为其他类似组件的优秀参考实现。新的交互系统包集成进一步增强了组件的功能性和可用性，为用户提供更加完善和一致的审批体验。