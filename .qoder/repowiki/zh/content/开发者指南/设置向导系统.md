...
## 更新摘要
**所做更改**
- 版本2重构：移除废弃的selectedModel字段，改进状态管理
- 增强OAuth认证支持：优化轮询机制和错误处理
- 改进状态迁移：v1到v2的平滑升级机制
- 优化UI组件：保持Radix UI组件库的一致性
...
**更新** 版本2移除了废弃的selectedModel字段，优化了状态结构

**章节来源**
- [ui-react/src/store/setup-wizard.store.ts:1-131](file://ui-react/src/store/setup-wizard.store.ts#L1-L131)
...
**章节来源**
- [ui-react/src/store/setup-wizard.store.ts:95-131](file://ui-react/src/store/setup-wizard.store.ts#L95-L131)
