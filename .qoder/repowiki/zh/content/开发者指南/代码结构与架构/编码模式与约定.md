...
- 文件组织：src/**/*、ui/**/*、extensions/**/* 统一纳入编译范围；dist 与 node_modules 排除。
...
- 覆盖率：仅统计 src/**/*，排除扩展、应用、UI、测试与入口文件，阈值 70%/70%/55%/70%。
...
### 文档与 Markdown 规范
- MarkdownLint：对 docs/**/*.md 与 README.md 生效，允许部分元素标签，关闭若干规则以适配文档结构。
...
- 覆盖率锚定：仅统计 src/**/*，避免大模块与集成面影响覆盖率稳定性。
