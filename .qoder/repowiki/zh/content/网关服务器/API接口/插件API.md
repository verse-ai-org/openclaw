...
- 插件类型与钩子
  ...
  - 钩子：包括 before_model_resolve、before_prompt_build、before_agent_start、llm_input、llm_output、agent_end、before_compaction、after_compaction、before_reset、message_*、tool_*、before_message_write、session_*、subagent_*、gateway_* 等。
- 插件加载与注册
