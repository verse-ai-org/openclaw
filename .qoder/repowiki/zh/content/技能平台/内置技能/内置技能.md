...
- [skills/travel-planner/SKILL.md:1-358](file://skills/travel-planner/SKILL.md#L1-L358)
...
**更新** 新增完整的旅行规划工作流，包括 Xiaohongshu 集成和改进的路由选择逻辑
...
## 结论
OpenClaw 的内置技能覆盖消息平台、生产力工具、媒体处理与系统工具四大类，以及新增的旅行规划和 Xiaohongshu 集成功能。通过 SKILL.md 明确了运行时依赖、配置要求与使用边界。新增的旅行规划技能提供了完整的旅行工作流，包括 Xiaohongshu 集成和改进的路由选择逻辑，为用户提供从规划到执行的全流程支持。遵循各技能的最佳实践与故障排除建议，可在保证安全性与稳定性的前提下高效完成自动化任务。
